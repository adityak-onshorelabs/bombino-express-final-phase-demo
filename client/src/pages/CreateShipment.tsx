...
export default function CreateShipment() {
  ...
  // A personal booking carries an identity document, and this screen is where
  // it is compelled. Signup already refuses to open the account without one,
  // so in practice this catches the legacy account that predates that rule.
  const kycBlocksBooking = kycRequired;
