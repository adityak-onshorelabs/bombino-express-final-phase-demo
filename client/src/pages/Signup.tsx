...
import { User, Mail, Phone, Building2, Loader2, ShieldCheck, MapPin } from 'lucide-react';
            ...
            {step === 'details' && accountType === 'company' && (
              <>
                ...
                <div>
                  ...
                  {errors.companyEmail && <p role="alert" className="text-sm text-red-500 mt-1.5">{errors.companyEmail}</p>}
                </div>

                <div>
                  <Label className="text-sm font-medium text-[lab(34.0831_-9.57756_-27.7093)]">Contact person</Label>
                  <div className="relative mt-2">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" />
                    <Input
                      value={contactPerson}
                ...
                <div>
                  <Label className="text-sm font-medium text-[lab(34.0831_-9.57756_-27.7093)]">Address</Label>
                  <div className="relative mt-2">
                ...
                <div>
                  <Label className="text-sm font-medium text-[lab(34.0831_-9.57756_-27.7093)]">Pincode</Label>
                  <Input
                    value={pincode}
                    onChange={(e) => {
                ...
                <div>
                  <Label className="text-sm font-medium text-[lab(34.0831_-9.57756_-27.7093)]">City</Label>
                  <Input
                    value={city}
                ...
                <div>
                  <Label className="text-sm font-medium text-[lab(34.0831_-9.57756_-27.7093)]">State</Label>
                  <Input
                    value={state}
                ...
                <div>
                  <Label className="text-sm font-medium text-[lab(34.0831_-9.57756_-27.7093)]">Hub</Label>
                  <Select
