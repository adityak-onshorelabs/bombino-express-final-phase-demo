...
export function DesktopTopBar() {
  ...
  return (
    <div className="hidden md:flex items-center justify-between h-14 bg-white/98 backdrop-blur-sm border-b border-border px-8 sticky top-0 z-10 shrink-0 shadow-[0_1px_8px_oklch(17%_0.048_248_/_0.07)]">
